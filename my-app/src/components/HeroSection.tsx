            ...
            >
              <div className="space-y-4">
                ...
                >
                  ...
                  Specializing in modern web applications with clean, efficient
                  code.
                </motion.p>
              </div>
              ...
              >
                ...
                <Button size="lg" variant="secondary" asChild className="group">
                  <a href="/hritik-saini-resume.pdf" download >
                  <FileDown className="mr-2 h-4 w-4 transition-transform group-hover:translate-x-2" />
                  Download Resume</a>
                </Button>
              </motion.div>
